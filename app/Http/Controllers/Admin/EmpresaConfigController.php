    ...
    public function update(Request $request)
{
    ...
    $data = $request->validate([
        ...
        'info_pago' => ['nullable', 'string', 'max:1000'],
    ]);
    ...
    if ($request->hasFile('banner_pago')) {
        $request->validate(['banner_pago' => ['image', 'max:3072']]);
        $data['banner_pago'] = $request->file('banner_pago')->store('banners', 'public');
    }
