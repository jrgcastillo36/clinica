...
<head>
    ...
    <style>
        .portal-header{background:var(--navy);color:#fff;padding:16px 30px;display:flex;align-items:center;gap:16px;flex-wrap:wrap}
        .portal-nav{margin-left:30px;display:flex;gap:6px}
        .portal-menu-toggle{display:none;margin-left:auto;background:none;border:none;color:#fff;font-size:20px;cursor:pointer;padding:4px 8px}
        ...
        @media(max-width:700px){
            ...
            .portal-nav{display:none;flex-basis:100%;order:10;flex-direction:column;gap:2px;margin:12px 0 0;padding-top:12px;border-top:1px solid rgba(255,255,255,.15)}
...
<body style="background:var(--bg)">
    ...
    <header class="portal-header">
        ...
        <button type="button" class="portal-menu-toggle" onclick="document.querySelector('.portal-nav').classList.toggle('open')">
